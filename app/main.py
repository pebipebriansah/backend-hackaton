...
from app.routes import authPetani, petani, rekomendasi, cuaca  # ✅ Tambahkan cuaca
...
app.include_router(cuaca.router, prefix="/cuaca", tags=["Cuaca"])  # ✅ Tambahkan router cuaca
